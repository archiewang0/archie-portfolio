...
import funguide1 from "public/img/funguide1.png"
import funguide2 from "public/img/funguide2.png"
import anhui1 from "public/img/anhui1.png"
import anhui2 from "public/img/anhui2.png"
    ...
    const datas: AccordionSectionProps  = {
        datas: [
            ...
            },
            {
                ...
                "describe": "Focused on the development and maintenance of front-end shared components for Lion Travel's B2C, B2B, and B2E platforms, improving system performance and user experience.",
                "skills": [
            ...
            },
            {
                ...
                "describe": "Collaborated with the design and backend teams to revamp Lion Travel's B2C platform, improving the membership workflow and interface details to enhance the overall user experience.",
                "skills": [
                    `skill-icons:react-${theme}`,
                    `skill-icons:nodejs-${theme}`,
                    "skill-icons:sass",
            ...
            },
            {
                ...
                "describe": "Collaborated with the design team to create the B2E landing page, utilizing elegant animations and layout design to enhance the corporate's image.",
                "skills": [
                    'skill-icons:jquery',
                    "skill-icons:html",
                    "skill-icons:sass",
            ...
            },
            {
                ...
                "describe": "For the opening of Lion Travel's physical store, ensured alignment with the store's overall visual theme. The marketing website echoed the style of the physical store, and collaborated with the design team through multiple discussions to refine the details of animation presentations.",
                "skills": [
                    'skill-icons:jquery',
                    "skill-icons:html",
                    "skill-icons:sass",
            ...
            },
            {
                ...
                "describe": "This webpage provides a comprehensive introduction to Tottori Prefecture's folk culture, culinary traditions, and natural landscapes, increasing the number of group tour sign-ups to Tottori Prefecture in Japan.",
                "skills": [
                    'skill-icons:jquery',
                    "skill-icons:html",
                    "skill-icons:sass",
            ...
            },
            {
                "id": "id-7",
                "time": "2021 JUL - 2023 JUL",
                "projectName": "Event Project - Fun Guide",
                "company": "Lion Travel",
                "webLink": "https://www.fjta.com.tw/event/fun-guide/xiamen.aspx",
                "describe": "Using a mini-game quiz format, users can learn about the cultural features of travel destinations.",
                "skills": [
                    'skill-icons:jquery',
                    "skill-icons:html",
                    "skill-icons:sass",
                ...
                "images": [
                    {"src": funguide1 , href: funguide1.src},
                    {"src": funguide2 , href: funguide2.src},
                ]
            ...
            },
            {
                "id": "id-8",
                "time": "2021 JUL - 2023 JUL",
                "projectName": "Event Project - Anhuitravel",
                "company": "Lion Travel",
                "webLink": "https://www.anhuitravel.com.tw/special_features/healthregimen/",
                "describe": "The marketing webpage for Anhui highlights the cultural features of the region to encourage consumers to travel there.",
                "skills": [
                    'skill-icons:jquery',
                    "skill-icons:html",
                    "skill-icons:sass",
                ...
                "images": [
                    {"src": anhui1 , href: anhui1.src},
                    {"src": anhui2 , href: anhui2.src},
                ]
            ...
            },
            {
                ...
                "describe": "The marketing webpage for Anhui showcases the cultural features of various locations and incorporates interactive mini-games to attract consumers and encourage them to visit.",
                "skills": [
                    'skill-icons:jquery',
                    "skill-icons:html",
                    "skill-icons:sass",
